...
const theme = createTheme({
  ...
  components: {
    ...
    MuiSelect: {
      styleOverrides: {
        root: {
          '& .MuiOutlinedInput-notchedOutline': { borderColor: '#ad9267' },
          '&:hover .MuiOutlinedInput-notchedOutline': { borderColor: '#d4b699' },
          '&.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: '#d4b699' },
